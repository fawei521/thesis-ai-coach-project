...
def t_power():
    print("\n【8/25】开题样本量 / 功效估算（G*Power 等价，回答要发多少份）")
...
def t_refs():
    print("\n【16/25】参考文献格式化（题录CSV → GB/T 7714-2015 编号列表，可直接粘进论文）")
...
def t_ppt():
    print("\n【21/25】把大纲排成 PPT（开题/答辩汇报 .pptx，只排版不代写）")
...
def t_workspace():
    print("\n【22/25】检查并补齐「我的工作区」：九个目录 ＋ 你的进度卡与检索记录")
