...
templates/          各类模板 + 网页范例/
tools/              14 个脚本（含 webpage_preview.py 网页预览器、anonymize_data.py 去标识化、effect_size.py 效应量换算复核、validity_cr_ave.py 聚合/区分效度、literature_cards.py 文献卡片）+ stats/ 统计实现包（9 个模块）
