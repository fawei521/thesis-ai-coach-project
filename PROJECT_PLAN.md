...
- **v1.6** ✅ 结构效度自动化（当前）：
  ...
  - 至此本科问卷量化论文标准分析全部脚本化
- **v1.7**（后续候选）：问卷星多选/填空进一步适配、量表库扩充、知网多学校路径配置、不装Python的Excel版统计、多维量表EFA(varimax旋转)脚本化
...
| auto_stats.py | 反向计分、α、结构效度(KMO/Bartlett/载荷)、Harman、量表总分、描述/相关/回归、Bootstrap中介模型4/6、三线表 | 标准库 |
