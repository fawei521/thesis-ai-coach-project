...
- **v1.35** ✅ 工具箱菜单4/5/6/7真人端到端走查与模型图崩溃修复（当前）：修复 chart_generator 的 --coefs 必填导致菜单第6项回车即报错退出，改为可省略自动补0、数量不符补齐/截断、非数字友好报错、去 SimHei bold 警告；实测菜单4英文检索(OpenAlex联网)/5文献整理/7演示数据均可用
