...
- **v1.5**（后续候选）：问卷星多选/填空进一步适配、量表库扩充、知网多学校路径配置、不装Python的Excel版统计
...
| auto_stats.py | 反向计分、α、Harman、量表总分、描述/相关/回归、三线表 | 标准库 |
| generate_demo_data.py | 生成可复现模拟数据供练手（严禁写进论文） | 标准库 |
