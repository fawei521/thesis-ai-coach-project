...
- **v1.32** ✅ 论文大纲模板与统计指南走查对齐（当前）：大纲结果章补正态性/EFA平行分析/人口学差异(t/Welch/ANOVA/非参数)/卡方/调节简单斜率，研究程序补未成年人监护人知情同意与质量埋点、数据处理补分半与Bootstrap；逐行核实stats-guide与代码一致无夸大；复核AI使用声明合规
