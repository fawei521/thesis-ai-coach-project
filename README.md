...
> 维护者/接手者：改动后运行 `python tests/full_e2e.py`（约3-5分钟，175项起，自动备份恢复测试数据），退出码 0 才算通过；学生日常使用不需要跑。

## 版本

**当前版本：v1.55**（2026-09-17）
...
**上一个版本：v1.54** 学生自己做网页（引导手册+本地预览器+3 个范例）+ 治理补齐 —— 更早版本详见 [CHANGELOG.md](CHANGELOG.md)。
