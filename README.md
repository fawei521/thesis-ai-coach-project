...
**当前版本：v1.97**（2026-09-21）**"改字"这个动作必须是你自己的**：上一版给了 AI 腔体检和写作留痕，这一版把配套那条判据补成机器查得出来的尺——你图省事说"你直接替我改自然一点，我不看了"，AI 接下这个活**就是不合格**：它改完交上去的还是 AI 的话，风险全在你身上。合格的做法是把体检点出的行号列给你、你自己逐句改，卡住的那句它带你顺，但话得你说出口。另一处变化在维护侧（版本史归档的引用不再靠人手工核对），学生侧零操作变化，工具与菜单都不需要重新学。
