...
> 维护者/接手者：改动后运行 `python tests/full_e2e.py`（约3-5分钟，198项起，自动备份恢复测试数据），退出码 0 才算通过；学生日常使用不需要跑。

## 版本

**当前版本：v1.56.1**（2026-09-17）
...
**上一个版本：v1.55** 豆包 Skill 轻量版入包（协议化引导＋鼓励系统＋12 阶段卡＋validate.py 自检门禁）—— 更早版本详见 [CHANGELOG.md](CHANGELOG.md)。
