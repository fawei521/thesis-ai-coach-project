...
> 版本 v1.84 ｜ 适用：心理学专业本科毕业论文（实证/问卷研究为主）｜ 学生把整个项目文件夹交给AI，AI从本文件开始（最新版本号以 CHANGELOG.md / git tag 为准；另有可安装到豆包的轻量 Skill 版，见 doubao-skill/）
...
- `menu.py` — 统一菜单（不想记命令时用；22 项，实现拆在 `menu_io.py`/`menu_data.py`/`menu_lit.py`）
