...
- [ ] **Skill 轻量版口径追平完整版**：同步点以 `doubao-skill/CHANGELOG.md` 最新一条为准（本文件不再复写版本号，
  过去四处各写一遍已造成过三个互相矛盾的数字，现由 `tests/skill_sync_check.py` 盯住）。
  追平前要逐节核对：量表库 39 组、ω/HTMT/CVI/项目分析、多重比较校正、前提假设检验、缺失机制与插补指引、
  开题就绪度自检（学生当前就在开题）、完整版菜单 21/22/23 项；**另有一处真错**：轻量版 stage-11 把完整版的
  "答辩高频问题库（24 问、7 类）"写成了"24 类高频问题"。核完出 Skill v1.5
