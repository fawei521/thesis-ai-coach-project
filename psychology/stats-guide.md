...
- **组合信度 CR**（Composite Reliability）：CR = (Σλ)² / [(Σλ)² + Σ(1−λ²)]，λ 为该因子各题的标准化载荷。CR≥.70 良好，.60–.70 在探索性研究可接受（Bagozzi & Yi, 1988；Hair 等），<.60 偏低。CR 不像 Cronbach's α 那样假设等载荷，是同源（congeneric）测量模型下更合适的内部一致性指标。
